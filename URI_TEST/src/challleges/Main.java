...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 6; i++) {
            parkingLot.park(
            		new Car(Vehicle.VehicleType.HANDICAPPED));
        }
        ...
        for (int j = 0; j < 8; j++) {
            parkingLot.park(
            		new Truck(Vehicle.VehicleType.REGULAR));
        }
        ...
        for(int k = 0; k < 3; k++) {
            parkingLot.park(
            		new Car(Vehicle.VehicleType.REGULAR));
        }
        ...
        parkingLot.park(
        		new Truck(Vehicle.VehicleType.HANDICAPPED));
        ...
        for(int m = 0; m < 3; m++) {
            parkingLot.park(
            		new Bike(Vehicle.VehicleType.REGULAR));
        }
